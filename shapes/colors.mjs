import { customColors } from "./custom/colors.mjs";
...
export let allowColorMixingMismatch = true;
export let allowColorMixingOverride = true;
export let allowColorMixingMissingSource = true;
export let allowColorMixingMissingTarget = true;
...
export function initColors() {
    ...
    for (let k in enumColorToShortcode) delete enumColorToShortcode[k];
    for (let k in enumShortcodeToColor) delete enumShortcodeToColor[k];
    for (let k in enumColorsToHexCode) delete enumColorsToHexCode[k];
    for (let data of customColors) {
        registerColor(data);
    }
